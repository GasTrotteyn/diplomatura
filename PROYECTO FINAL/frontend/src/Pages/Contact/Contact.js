...
const Contact = (props) => {
	...
	let classesArrayForButton = [classes.button, data.formIsValid 
        //&& captchaOK 
        ? null : classes.alertButton].join(' ')
		...
		<div className={classes.container}>
			...
			<div className={classes.dataSection}>
				<div className={classes.ourInfo}>
					...
					<p>
						Please contact us with any questions about building your custom van conversion. Let’s get you started on
						living the van life!
					</p>
