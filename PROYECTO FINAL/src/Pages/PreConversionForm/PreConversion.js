...
const Contact = (props) => {
	...
	const inputChangeHandler = (event, id) => {
		...
		elementModified.valid = checkValidity(formModified.form[id].value, formModified.form[id].validation)
		...
		<div className={classes.container}>
			...
			<div className={classes.dataSection}>
				<div className={classes.ourInfo}>
					...
					<p>
						We're excited to ger started building your van! Whether it's just for weekend camping with the family, a
						work van, or a full-time residence, we'll make a home perfectly suited to your unique needs.
					</p>
				</div>
				<div className={classes.yourInfo}>
					<form onSubmit={submitHandler}>
						...
						<p className={classes.note}>
							Thank you for the information! Chaeck your email for a message from our team with the next step. If you
							asked specific question please allow 1-2 business days for us to get back to you with your answer!
						</p>
